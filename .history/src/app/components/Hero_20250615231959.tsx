  ...
  return (
    <section className="h-screen flex items-center justify-center relative overflow-hidden">
      ...
      <div className="text-center z-10 px-4">
        <h1 className="text-xs md:text-sm cyber-text mb-1">
          V3XV0ID
        </h1>
        
        <div className="w-8 h-px bg-white mx-auto mb-1"></div>
        
        <p className="text-[8px] md:text-[10px] text-white mb-2 lo-fi-text">
          DIGITAL MUSICIAN & HACKER
        </p>
        
        <div className="flex justify-center gap-1 text-[6px] md:text-[8px]">
          <a href="#audio" className="bg-white text-black px-1 py-0.5 lo-fi-text">AUDIO</a>
          <a href="#visual" className="border border-white text-white px-1 py-0.5 lo-fi-text">VISUAL</a>
          <a href="#projects" className="border border-white text-white px-1 py-0.5 lo-fi-text">PROJ</a>
        </div>
      </div>
