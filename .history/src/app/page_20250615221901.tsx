...
export default function Home() {
  return (
    <main className="min-h-screen">
      {/* CSS Test Section */}
      <section className="h-screen flex items-center justify-center bg-dark-bg">
        <div className="text-center">
          <h1 className="text-6xl font-mono mb-6 neon-text">
            V3XV0ID
          </h1>
          <p className="text-xl text-neon-blue mb-8">
            CSS Test - If you see neon green and blue, CSS is working!
          </p>
          <div className="p-6 neon-border rounded-lg">
            <h3 className="text-xl font-mono mb-4">Test Box</h3>
            <p className="text-gray-300">This should have a glowing green border.</p>
          </div>
        </div>
      </section>

      {/* Original content temporarily commented out */}
      {/* <Hero />
      <ConceptArtGallery /> */}
